...
public class ImageSubmissionController {
    ...
    public ImageSubmissionResponse create(@RequestParam String email, @RequestParam MultipartFile file) throws IOException {
        ...
        ImageSubmission entity = ImageSubmission.builder()
                .id(UUID.randomUUID())
